          ...
          children:[
            Expanded(
              child:Container(
                ...
                child:Center(
                  child:Text('flutter',style:GoogleFonts.comfortaa(
                    fontSize: 25,
                    color:Colors.white,
                  ),
            ...
            Container(
              ...
              child:Row(
                ...
                children: [
                  ...
                  Spacer(flex:1),
                  _btnL(col: Colors.redAccent[400],st:'KR',l:Locale('ko','KR')),
                  Spacer(flex:1),
                  _btnL(col: Colors.lightBlueAccent[700],st:'JP',l:Locale('ja','JP')),
                ],
              ),
            ),
          ],
